...
function SubmitButton() {
  const [status, formAction, isPending] = useActionState(submitContact, null);

  return (
    <Button type="submit" className="w-full text-foreground dark:text-foreground disabled:bg-disabled disabled:text-disabled" disabled={isPending}>
  ...
  return (
    <div className="bg-background min-h-screen pt-20">
      ...
      <motion.div
        ...
        className="bg-background  py-12 mt-12"
      >
